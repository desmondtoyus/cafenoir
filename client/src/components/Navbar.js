      ...
      <div className="container">
        <div className="flex-container">
          ...
          <ul className="nav navbar-nav flex-item hidden-xs pull-right">
                {(isLoggedIn()) ?
                  (<span>
                    <li className="login-button"><Link to="/Profile" style={{ display: 'inlineBlock',  paddingLeft: '0px', marginRight: '15px' }}>View Profile</Link></li>
                    <li className="signup-button" style={{ display:'inlineBlock'}} onClick={() => logout()}>Signout</li>
                  </span>)
                  : (<span><li className="login-button" style={{ display: 'inlineBlock', paddingLeft: '0px', marginRight: '15px'  }} onClick={() => login()}>Login</li>
                    <li className="signup-button" style={{ display: 'inlineBlock' }} onClick={() => login()}>Signup</li>
                  </span>)
                }
          </ul>
